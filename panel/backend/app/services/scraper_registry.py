...
SCRAPERS: tuple[ScraperSpec, ...] = (
    ScraperSpec(
        ...
        description="Business leads from Google Maps (keyword × location).",
        implemented=True,
        risk="managed",
    ...
    ScraperSpec(
        ...
        group=GROUP_FACEBOOK,
        group_label="Meta / Facebook",
        description="Public Facebook groups.",
        implemented=True,
        risk="very_high",
        inputs="keywords × locations",
    ),
    ScraperSpec(
        ...
        group=GROUP_FACEBOOK,
        group_label="Meta / Facebook",
        description="Facebook post content and metadata.",
        implemented=True,
        risk="very_high",
        inputs="keywords × locations",
    ),
    ScraperSpec(
        ...
        group=GROUP_FACEBOOK,
        group_label="Meta / Facebook",
        description="Comment threads / post URLs (public discovery; limited without login).",
        implemented=True,
        risk="very_high",
        inputs="keywords × locations",
    ),
    ScraperSpec(
        ...
        group=GROUP_SOCIAL,
        group_label="Social",
        description="Public Instagram profiles / posts via search discovery.",
        implemented=True,
        risk="very_high",
        inputs="keywords × locations",
    ),
    ScraperSpec(
        ...
        group=GROUP_SOCIAL,
        group_label="Social",
        description="General TikTok profiles (distinct from TikTok Shop).",
        implemented=True,
        risk="very_high",
        inputs="keywords × locations",
    ),
    ScraperSpec(
        ...
        group=GROUP_SOCIAL,
        group_label="Social",
        description="YouTube search results / videos / channels.",
        implemented=True,
        risk="high",
        inputs="keywords × locations",
    ),
    ScraperSpec(
        ...
        group=GROUP_SOCIAL,
        group_label="Social",
        description="Reddit search posts (public).",
        implemented=True,
        risk="high",
        inputs="keywords × locations",
    ),
    ScraperSpec(
        ...
        group=GROUP_SOCIAL,
        group_label="Social",
        description="Pinterest pin search (public).",
        implemented=True,
        risk="high",
        inputs="keywords × locations",
    ),
    ScraperSpec(
        ...
        group=GROUP_SOCIAL,
        group_label="Social",
        description="Public LinkedIn profiles / company pages (SERP discovery).",
        implemented=True,
        risk="extreme",
        inputs="keywords × locations",
    ),
    ScraperSpec(
        ...
        group=GROUP_SOCIAL,
        group_label="Social",
        description="Public X profiles / posts (SERP discovery).",
        implemented=True,
        risk="extreme",
        inputs="keywords × locations",
    ),
